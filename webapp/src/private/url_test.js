...
describe("module:url", () => {
	describe("mailto", it.bind(undefined, "should return the URL of the given address", () => {
	...
	describe("tel", it.bind(undefined, "should return the URL of the given telphone number", () => {
