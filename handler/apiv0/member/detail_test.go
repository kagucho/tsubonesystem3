  ...
  func() {
    ...
    for _, test := range [...]struct{
        ...
        }{
          {
            `invalidID`, ``,
            authorizer.Claim{
              Sub: `1stDisplayID`, Scope: scope.Scope{}.Set(scope.Basic),
            ...
            http.StatusOK,
            `{"affiliation":"理学部第一部 数理情報科学科","clubs":[{"chief":false,"id":"prog","name":"Prog部"}],"entrance":1901,"gender":"男","mail":"1st@kagucho.net","nickname":" !\\%_1\"#","ob":false,"positions":[{"id":"president","name":"局長"}],"realname":"$\u0026\\%_2'(","tel":"012-345-567"}`,
          }, {
            `chief`, `id=2ndDisplayID`,
            authorizer.Claim{Scope: scope.Scope{}.Set(scope.Basic)},
            http.StatusOK,
            `{"affiliation":"","clubs":[{"chief":true,"id":"prog","name":"Prog部"}],"entrance":1901,"gender":"女","mail":"","nickname":" !%_1\"#","ob":false,"positions":[],"realname":"$\u0026\\%_2'(","tel":""}`,
          }, {
            `same`, `id=3rdDisplayID`,
            authorizer.Claim{
              Sub: `3rdDisplayID`, Scope: scope.Scope{}.Set(scope.Basic),
            }, http.StatusOK,
             `{"affiliation":"","clubs":[],"entrance":1901,"gender":"","mail":"","nickname":" !\\%*1\"#","ob":false,"positions":[],"realname":"$\u0026\\%_2'(","tel":""}`,
          }, {
            ...
            authorizer.Claim{Scope: scope.Scope{}.Set(scope.Basic)},
            http.StatusOK,
            `{"affiliation":"","clubs":[],"entrance":1901,"gender":"","mail":"","nickname":" !\\%*1\"#","ob":false,"positions":[],"realname":"$\u0026\\%_2'("}`,
          },
        } {
